...
extension ConversationViewController: MessagesLayoutDelegate {//5. Setting up the display n layout delegate
...
extension ConversationViewController: MessagesDataSource { //4. Setting up the chat interface configuring the data source
...
extension ConversationViewController: InputBarAccessoryViewDelegate { //11.
